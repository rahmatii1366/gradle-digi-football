package ir.piana.dev.core.generator.swagger;
 ...
 * Date: 6/16/2019 5:48 PM
 **/
public class SpringVertXCodegen extends AbstractJavaCodegen {
    ...
    public static final String NAME = "spring-vertx";
    ...
    public void processOpts() {
        ...
        supportingFiles.add(new SupportingFile("swagger.mustache", resourceFolder + File.separator + apiPackage.replace(".", File.separator), "swagger.json"));
        supportingFiles.add(new SupportingFile("MainApiVerticle.mustache", sourceFolder + File.separator + apiPackage.replace(".", File.separator), "MainApiVerticle.java"));
